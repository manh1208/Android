...
/**
 * Created by ManhNV on 05/23/2015.
 */
public class Member implements Serializable, ISqliteTable, Parcelable {
    ...
    public void setValue(Cursor cursor) {
        ...
        this.setLastMonth(cursor.getString(cursor.getColumnIndex("LastMonth")));
    ...
    public ContentValues getContentValues() {
        ...
        values.put("LastMonth",this.getLastMonth());
    ...
    public String getFullName(){
        return  this.getLastName()+" "+this.getMiddleName()+" "+this.getFirstName();
    }
